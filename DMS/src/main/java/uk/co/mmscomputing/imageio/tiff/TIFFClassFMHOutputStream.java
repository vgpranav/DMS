...
public class TIFFClassFMHOutputStream extends TIFFClassFOutputStream{

  public TIFFClassFMHOutputStream(OutputStream out)throws IOException{
    super(out);
  }

  @Override
public void write(int cw)throws IOException{          // MH code 'bytes'
...
public void writePageHeader(int width)throws IOException{
    super.writePageHeader(width);
    super.write(0x00);super.write(0x80);                // eol before data
  }
...
public void writePageEnd()throws IOException{
    ...
    writeShort(LONG);
    writeInt(1);    
    writeInt(4);                               // 292 MH; byte aligned EOLs
