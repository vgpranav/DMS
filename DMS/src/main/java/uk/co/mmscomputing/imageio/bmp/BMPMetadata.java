...
public class BMPMetadata extends IIOMetadata implements BMPConstants{
  ...
  public void setXDotsPerInch(int v){xPixelsPerMeter=(int)Math.round((v)*1000.0/25.4);}
  public void setYDotsPerInch(int v){yPixelsPerMeter=(int)Math.round((v)*1000.0/25.4);}
  ...
  public int getXDotsPerInch(){return (int)Math.round((xPixelsPerMeter)*25.4/1000.0);}
  public int getYDotsPerInch(){return (int)Math.round((yPixelsPerMeter)*25.4/1000.0);}
