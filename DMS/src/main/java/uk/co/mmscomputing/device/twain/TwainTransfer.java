...
public class TwainTransfer implements TwainConstants, TwainITransfer {
  ...
  public static class NativeTransfer extends TwainTransfer{
    ...
    private byte[] imageHandle=new byte[8];                // 32 bit ptr size: 4; 64 bit ptr size: 8
  ...
  public static class MemoryTransfer extends TwainTransfer{
    ...
    private byte[]  imx     = new byte[38];                                 // TW_IMAGEMEMXFER
    private Info    info;
    ...
    public static class Info{
      ...
      public int getTop(){return jtwain.getINT32(imx,14);}          // xoffset
      public int getLeft(){return jtwain.getINT32(imx,18);}         // yoffset
