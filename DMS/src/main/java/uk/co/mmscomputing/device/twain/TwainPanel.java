...
*/
    ...
    switch(mode){
    case 0:
      acqbutton=new JButton("Capture");
      selbutton=new JButton("Scanner");
      setLayout(new GridLayout(0,1));
      break;
    case 1:
      acqbutton=new JButton("Capture");
      ...
      break;
    case 2:
      acqbutton=new JButton("Capture",new JarImageIcon(getClass(),"16x16/scanner.png"));
      selbutton=new JButton("Scanner",new JarImageIcon(getClass(),"16x16/list.png"));
      setLayout(new GridLayout(0,1));
      break;
    case 3:
      acqbutton=new JButton("Capture",new JarImageIcon(getClass(),"16x16/scanner.png"));
      ...
      break;
    case 4:
      acqbutton=new JButton("Capture",new JarImageIcon(getClass(),"32x32/scanner.png"));
      selbutton=new JButton("Scanner",new JarImageIcon(getClass(),"32x32/list.png"));
      setLayout(new GridLayout(0,1));
      break;
    case 5:
      acqbutton=new JButton("Capture",new JarImageIcon(getClass(),"32x32/scanner.png"));
    ...
    acqbutton.addActionListener(EventHandler.create(ActionListener.class, this, "acquire"));
    add(acqbutton);
/*
    guicheckbox = new JCheckBox("Enable GUI");
    guicheckbox.setSelected(true);
...
*/
    ...
    selbutton.addActionListener(EventHandler.create(ActionListener.class, this, "select"));
    add(selbutton);
