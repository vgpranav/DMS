					...
					<div class="form-group">
						...
						<c:if test="${type=='builder'}">
							...
							<div class="col-md-8 col-sm-8 col-xs-12">
								<select name="societyid" id="builderid" class="form-control">
						...
						<c:if test="${type=='project'}">
							...
							<div class="form-group">
								...
								<div class="col-md-8 col-sm-8 col-xs-12">
									<select name="societyid" id="projectid" class="form-control" onchange="getSubProjects()" required="required">
										<option value=""> -- select -- </option>
									</select>
								</div>
							</div>
						...
						<c:if test="${type=='subproject'}">
							...
							<div class="form-group">
								...
								<div class="col-md-8 col-sm-8 col-xs-12">
									<select name="societyid" id="societyid" class="form-control" required="required">
										<option value=""> -- select -- </option>
									</select>
								</div>
							</div>
						...
						<input type="hidden" name="doctypeid" value="${typeVal}">
						<input type="hidden" name="docsubtypeid" value="${typeVal}">
						<input type="hidden" name="userid" value="${typeVal}">
