...
function getUserActivityLog(){
	...
	$.ajax({
        type: "GET",
        url: "<%=request.getContextPath()%>/getUserLoginHistory.do",
        data :reqStr,
        ...
        success: function(response){
        	...
        	$.each(response, function(i, item) {
        		...
        		if(item.logouttime!=null)
        			logouttime = new Date(item.logouttime).toString("dd MMM yyyy HH:mm");
        		
        		if(item.logintime!=null)
        			logintime = new Date(item.logintime).toString("dd MMM yyyy HH:mm");
